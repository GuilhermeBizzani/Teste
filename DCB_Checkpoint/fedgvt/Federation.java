...
public class Federation // classe que armazena os ids das federações e armazena a lista de federados dessa federação
{
	public String id;
	...
	public void AddFederate (Federate Temp) // Adiciona um federado a lista da federação
