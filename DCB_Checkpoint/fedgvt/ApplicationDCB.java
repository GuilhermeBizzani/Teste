...
{							               // todas as classes estão aninhadas dentro dessa classe principal
	public DCB NewDCB;
	public EDCB NewEDCB;
	public EF NewEF;
	public Gateway NewGateway;

	public String UniqueFederationID; // ID único da fedaração a que o federado pertence
	public String UniqueFederateID;   // ID único do federado
	...
	// 2.Indice da thread (que será utilizado para identificar o gateway) ISSO DEVE SER PREVIAMENTE ESPECIFICADO
	...
	public ApplicationDCB(DCBMThread p, int gatewayVal, String cfg) throws IOException // construtor
	{
		...
		//this.gatewayVal = gatewayVal + 1; // Os indices p/ as threads inicia em zero
						  			      // Somar 1 é necessário para que os gateways possam iniciar em 1
	...
	/////////////////////////////////////////////////////////////////////////////////////
	// Repassa mensagem para a classe DCBMThread que se encarregará de envia-la para
	...
	/////////////////////////////////////////////////////////////////////////////////////
	// Carrega as configurações utilizadas pelo DCB e EDCB a partir de um arquivo XML
	// e armazena essas configuracoes em listas de objetos
	// ***  A unica difereca desse metodo em relacao a versão que não utiliza thread é
