...
{	
	...
	public String federate_id;              					  // Armazena o número de threads criadas
	...
	// sobre os federados que serão executados em diferentes threads.
	...
	public DCBMThread(String args[]) throws IOException // construtor
	{
		...
		{
			DCBThread[currentThread] = new ApplicationDCB (this, currentThread, args[x]); // Cria uma nova thread para tratar a conexão
	...
	//  Esse metodo procura a thread onde o federado está executando e 
